...
public class TeamSetup {
    ...
    private Midfielder mcM1 = new Midfielder("", "Rodri", "MC", 24, 14, 15, 15,13);
    private Midfielder mcM2 = new Midfielder("Kevin", "De Bruyne", "MC", 29, 18, 16, 9,15);
    ...
    private Midfielder thM1 = new Midfielder("Pierre-Emile","Højbjerg","MC",25,15,14,16,11);
    private Midfielder thM2 = new Midfielder("Rodrigo","Bentancur","MC",23,14,15,16,14);
