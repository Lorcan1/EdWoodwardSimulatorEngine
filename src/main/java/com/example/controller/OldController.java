...
//    private final TeamSetupLogic teamSetupLogic;
//    Map<String, Player> positions= new HashMap<>();
//
//
//
//    public Controller(OutfieldPlayerRepository outfieldPlayerRepository, GoalkeeperRepository goalkeeperRepository, TeamSetupLogic teamSetupLogic) {
//        this.outfieldPlayerRepository = outfieldPlayerRepository;
//        this.goalkeeperRepository = goalkeeperRepository;
//        this.teamSetupLogic = teamSetupLogic;
//    }
//
...
//        club = returnFullClubName(club);
//        List<Player> team = teamSetupLogic.returnStartingEleven(club);
//        ObjectMapper objectMapper = new ObjectMapper();
...
//        MatchEngine matchEngine = new MatchEngine(teamSetupLogic, homeClubNameFull, awayClubNameFull);
